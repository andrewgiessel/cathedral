...
Report bugs at https://github.com/andrewgiessel/cathedral/issues
...
Ready to contribute? Here's how to set up `cathedral` for local development.
Please note this documentation assumes you already have `uv` and `Git` installed and ready to go.

1. Fork the `cathedral` repo on GitHub.

2. Clone your fork locally:

```bash
cd <directory_in_which_repo_should_be_created>
git clone git@github.com:YOUR_NAME/cathedral.git
```
